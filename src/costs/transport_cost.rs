...
impl<V: Variant> Default for TransportCost<V> {
    fn default() -> Self {
        Self::new(Cost::zero())
    }
}
...
impl<V: Variant> TransportCost<V> {
    pub fn new(global_unit_transport_cost: V::C) -> Self {
        Self {
            global: global_unit_transport_cost,
    ...
    pub fn global(&mut self, global_unit_transport_cost: V::C) {
        self.global = global_unit_transport_cost
    }
